function [ indicator_ext ] = extrapolateMatchIndicator( cdata, matchList, indicator, search_radius )
% function [ indicator_ext ] = extrapolateMatchIndicator(folder,matchList, indicator, search_radius )
...
%     XY_view1= folder.locs1(matchList(:,1),1:2);
%     XY_view2= folder.locs2(matchList(:,2),1:2); 
